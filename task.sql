...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2023 at 07:35 PM
...
(5, '2023_10_08_155238_create_user_notifications_table', 1),
(6, '2023_10_08_161550_add_last_sent_at_to_user_notifications', 1);
...
CREATE TABLE `users` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `email` varchar(255) DEFAULT 'hmmdkhan2022@gmail.com',
